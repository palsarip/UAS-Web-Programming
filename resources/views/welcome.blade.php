...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased h-full">
        ...
        <div class="absolute top-0 w-full h-full mt-[2em]">
            ...
            <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="reserve-modal" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
                ...
                <div class="modal-header text-center flex flex-shrink-0 items-center justify-center p-4 border-b border-gray-200 rounded-t-md">
                    <h5 class="text-xl text-center font-medium leading-normal text-orange-500" id="exampleModalScrollableLabel">
                    ...
                    @csrf
                        <div class="block w-full h-full">
                            <div>
                                ...
                                <div class="mt-1">
                                <input type="text" name="nama" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray- bg-white bg-clip-padding border border-solid border-gray-300 rounded-lg transition m-0 focus:outline-none focus:ring-2 focus:ring-orange-600 focus:border-transparent ease-out duration-100" >
                                </div>
                            </div>
                            <div class="mt-[0.75em]">
                                <label for="name" class="block text-base font-normal text-black">Adress</label>
                                <div class="mt-1">
                                <input type="text" name="alamat" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray- bg-white bg-clip-padding border border-solid border-gray-300 rounded-lg transition m-0 focus:outline-none focus:ring-2 focus:ring-orange-600 focus:border-transparent ease-out duration-100" >
                                </div>
                            </div>
                            <div class="mt-[0.75em]">
                                <label for="name" class="block text-base font-normal text-black">Date</label>
                                <div class="mt-1">
                                <input type="date" name="tanggal_reservasi" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray- bg-white bg-clip-padding border border-solid border-gray-300 rounded-lg transition m-0 focus:outline-none focus:ring-2 focus:ring-orange-600 focus:border-transparent ease-out duration-100" >
                                </div>
                            </div>
