...
@section('content')
  <div class="">
                ...
                @if($reservation->status == 0)
                  <tbody>
                    <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                      ...
                      <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                        <div class="flex">
                        <form action="/reservations/approved/{{$reservation->id}}" method="POST">
                          @csrf
                          <button href="" class="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-4 rounded-full mr-2 transition duration-300 ease">Approve</button>
                        </form>
                        <form action="/reservations/rejected/{{$reservation->id}}" method="POST">
                          @csrf
                          <button href="" class="bg-red-500 mr-2 hover:bg-red-600 text-white font-bold py-1 px-4 rounded-full transition duration-300 ease">Reject</button>
                        </form>
                        </div>
                      </td>
                      <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
    ...
    <h5 class="text-xl font-bold mb-2">Approved list</h5>
    <div class="flex flex-col border-2 rounded-lg px-[2em]">
      <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
          <div class="overflow-hidden">
    ...
    <hr class="border-2 bg-gray-400 opacity-1 rounded-full my-[2em]">
    <h5 class="text-xl font-bold mb-2">Rejected list</h5>
    <div class="flex flex-col border-2 rounded-lg px-[2em]">
      <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
          <div class="overflow-hidden">
